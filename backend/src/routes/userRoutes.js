...
import { listUsers, makeAdmin, revokeAdmin, listUsersWithCv, editUser, adminSetUserStatus } from "../controllers/user.controller.js";
...
router.get("/admin", requireAuth, requireRole("admin"), listUsersWithCv);
